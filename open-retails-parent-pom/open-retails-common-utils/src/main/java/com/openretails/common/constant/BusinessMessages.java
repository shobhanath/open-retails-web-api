...
public final class BusinessMessages {
	public static final String VALIDATE_FULL_ADDRESS = "Full address should not be null or empty";
	public static final String VALIDATE_AGE = "Age must be between 1 and 100";
