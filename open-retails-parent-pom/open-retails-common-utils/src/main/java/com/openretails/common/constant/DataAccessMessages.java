...
public final class DataAccessMessages {
	...
	public static final String USERS_NOT_FOUND = "User not found with the given user details -> %s";
	...
	public static final String FAILED_TO_FETCH_USERS_BY_ID = "Failed to fetch user by identity -> %s";
	public static final String FAILED_TO_FETCH_USERS_BY_IDS = "Failed to fetch user by identities -> %s";
	public static final String USER_EXIST_BY_EMAIL = "User already exist either with the username or email id -> %s.Incase user is inactive please contact technical admin to activate the user";
	public static final String FAILED_TO_FETCH_USERS_BY_USERNAME_OR_EMAIL = "Failed to fetch users by either username or primary email id -> %s";
