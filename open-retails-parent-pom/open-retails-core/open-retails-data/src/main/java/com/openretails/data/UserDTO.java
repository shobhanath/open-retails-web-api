...
public class UserDTO extends BaseDTO {
	...
	@NotNull(message = UserValidationMessages.VALIDATE_FIRST_NAME,groups = {New.class,Existing.class})
	...
	@NotNull(message = UserValidationMessages.VALIDATE_PRIMARY_EMIL_ADDRESS,groups = {New.class,Existing.class})
	...
	@NotNull(message = UserValidationMessages.VALIDATE_PASSWORD,groups = New.class)
	...
	@NotNull(message = UserValidationMessages.VALIDATE_USERNAME,groups= {New.class,Existing.class})
