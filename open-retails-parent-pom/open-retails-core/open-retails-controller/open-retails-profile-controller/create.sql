...
create table t_address (entity_id int8 not null, created timestamp not null, modified timestamp, obsolete boolean not null, address_free_text varchar(255) not null, comment varchar(255) not null, primary key (entity_id))
