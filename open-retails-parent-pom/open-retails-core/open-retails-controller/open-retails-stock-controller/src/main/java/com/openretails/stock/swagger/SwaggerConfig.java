package com.openretails.stock.swagger;
...
public class SwaggerConfig {
	...
	@Value("${stock.release.version}")
	private String releaseVersion;

	@Value("${stock.swagger.basepackage}")
	...
	private ApiInfo apiInfo() {
		final String title = "STOCK AND PRODUCT MANAGEMENT FOR OPEN RETAILS";
		final String description = "This is stock and product management services where product, stock, offer and price with GST is managed";
